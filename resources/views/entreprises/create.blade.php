    ...
    <x-app-layout>
        <div class="container mx-auto mt-8 max-w-md">
            <h2 class="text-center text-2xl font-bold mb-6">Création d'une entreprise</h2>

            <form action="{{ route('entreprises.store') }}" method="POST" class="bg-form shadow-md rounded px-8 pt-6 pb-8 mb-4">
                @csrf

                <div class="mb-5">
                    <label for="nom" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nom:</label>
                ...
                <div class="mb-5">
                    <label for="pays" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Pays:</label>
                ...
                <div class="mb-5">
                    <label for="quartier" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Quartier:</label>
                    <input type="text" id="quartier" name="quartier" value="{{ old('quartier') }}" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 @error('quartier') border-red-500 @enderror">
                    @error('quartier')
                        <span class="text-red-500 text-sm">Champ requis</span>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    <label for="adresse" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Adresse:</label>
